...
public class LibrarySample : MonoBehaviour {
	...
	void OnGUIServer()
	{
        ...
        //보내려는 메세지 박스
        GUI.TextField(new Rect(220, 400, 300, 30), m_strings);
    }


	void OnGUIClient()
	{
        m_sendComment = GUI.TextField(new Rect(220, 400, 300, 30), m_sendComment);
        ...
        GUI.TextField(new Rect(20, 400, 300, 30), m_sendComment);
    }
